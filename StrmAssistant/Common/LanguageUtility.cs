...
#else
        // Jellyfin 构建：这些方法由 Emby 插件使用，Jellyfin 插件不需要，提供空实现避免未引用
        public static List<string> GetMovieDbFallbackLanguages() => new List<string>();
        public static bool HasMovieDbJapaneseFallback() => false;
        public static bool BlockMovieDbNonFallbackLanguage(string input) => false;
        public static List<string> GetTvdbFallbackLanguages() => new List<string>();
        public static bool HasTvdbJapaneseFallback() => false;
        public static bool BlockTvdbNonFallbackLanguage(string input) => false;
#endif
    }
}
